...
function AcceuilContent() {
  ...
  return (
    <div>
      {user && user.role === "admin" && (
        <div className="container-fluid">
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <div>
              <h1 className="h3 mb-0 text-gray-800">Acceuil</h1>
              <div className="mt-4">
                <h2 className="text-sm text-200 float-left  ">
      ...
      {user && (user.role === "medecin" || user.role === "secretaire") && (
        <div className="container-fluid">
          {/* Page Heading */}
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Acceuil</h1>
          ...
          <div className="row">
            {/* rendez-vous Card  */}
            <Card title="Rendez-vous aujourdh'ui" nbRendez_vous={10}></Card>

            {/* nbre patients Card  */}
            <Card title="Patients" nbRendez_vous={22}></Card>
          </div>
          {/* Content Row */}
          {/* <div className="row"> */}
            {/* Area Chart */}
            ...
            {/* <div className="col-lg-6 mb-4">
              ...
              <div className="card shadow mb-4">
                ...
                <div className="card-body">
                  ...
                  <div className="progress mb-4">
                    <div className="progress-bar" role="progressbar a4" />
                  </div>
                  <h4 className="small font-weight-bold">
